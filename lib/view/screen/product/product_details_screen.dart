...
class _ProductDetailsState extends State<ProductDetails> {
  _loadData( BuildContext context) async{
    if(widget.banner){
      Provider.of<BannerProvider>(context, listen: false).getProductDetails(context, widget.product.id.toString());
      Provider.of<ProductDetailsProvider>(context, listen: false).removePrevReview();
      Provider.of<ProductDetailsProvider>(context, listen: false).initProduct(Provider.of<BannerProvider>(context, listen: false).product, context);
      ...
      Provider.of<ProductDetailsProvider>(context, listen: false).getSharableLink(widget.product.id.toString(), context);
